...
def __coerce_return(name, source_cls):
    """Helper to coerce return type on methods that explicitly create an
    instance of its class rather than relying on reflection to 
    determine the appropriate object to create.
    """
